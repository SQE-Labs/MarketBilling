...
public class Flow6_7AddingServiceAndMeter extends TestLogin {
	...
	public static class X_AddService {
		...
		public static By RetailElectricity_Plus_Subtab = By.xpath("(//i[@class='icon-minus'])[2]");
		...
		public static By ServiceAssertion =By.xpath("//div[@id='alert_service_created']");
	...
	//		WebDriverWaits.ClickOn(SelectCurrentDate);
			...
			WebDriverWaits.SendKeys(Move_In_Date_Datepicker, "23/11/2022");
			...
			//Assertion  Success! The Service has been created successfully. 
			String ActualServiceSucessMsg = WebDriverWaits.GetText(ServiceAssertion);
			String ExpectedMsg = "Success! The Service has been created successfully.";
			softAssert.assertEquals(ExpectedMsg, ActualServiceSucessMsg);
			softAssert.assertAll();
			System.out.println("The First  Service for residential customer has been created successfully");
			jse.executeScript("window.scrollBy(0,-300)", "");
		...
		public static void EditService() throws InterruptedException {
			...
			softAssert.assertAll();
			System.out.println("Successfully edited the First  Service for residential customer.");
			jse.executeScript("window.scrollTo(0, document.body.scrollHeight)");
	//		Metering.AddMeter();
//			Thread.sleep(2000);
		}
	...
	//		WebDriverWaits.ClickOn(SelectCurrentDate);
			...
			WebDriverWaits.ClickOn(AddButton);
			//Assertion  Success! The Service has been created successfully. 
			String ActualSecServiceSucessMsg = WebDriverWaits.GetText(ServiceAssertion);
			String ExpectedMsg = "Success! The Service has been created successfully.";
			softAssert.assertEquals(ExpectedMsg, ActualSecServiceSucessMsg);
			softAssert.assertAll();
			System.out.println("The Second  Service for Business customer has been created successfully");
			jse.executeScript("window.scrollBy(0,-300)", "");
		}
		...
		public static void EditSecondService() throws InterruptedException {
			...
			softAssert.assertEquals(ExpectedMsg1, ActualMsg);
			softAssert.assertAll();
			System.out.println("Successfully edited the Second  Service for Business customer.");
			
		}
		
		public static void BAddservice_Meter_MeterRegister() throws InterruptedException {
...
//			Metering.AddMeter();
//			Thread.sleep(2000);
//			System.out.println("Successfully added meter for the Second Business customer.");
		}
...
//			WebDriverWaits.ClickOn(SelectCurrentDate);
			...
			select.selectByVisibleText("New South Wales");
			WebDriverWaits.ClickOn(AddButton);
			String ActualThirdServiceSucessMsg = WebDriverWaits.GetText(ServiceAssertion);
			String ExpectedMsg = "Success! The Service has been created successfully.";
			softAssert.assertEquals(ExpectedMsg, ActualThirdServiceSucessMsg);
			softAssert.assertAll();
...
return  ServiceIDLater3;
		...
		public static void EditThirdService() throws InterruptedException {
			...
			softAssert.assertEquals(ExpectedMsg1, ActualMsg);
			softAssert.assertAll();
			System.out.println("The Third  Service for Commercial customer");
			Thread.sleep(4000);
			jse.executeScript("window.scrollTo(0, document.body.scrollHeight)");

		}
		public static void AddService_Meter_MeterRegisterC() throws InterruptedException {
	...
	public static class Metering {
		...
		public static By CustomerSuccessMeter =By.xpath("//div[@class='alert alert-success']/center");
...
//            Thread.sleep(8000);
//            boolean MeterState = AddMeterIconJS.isDisplayed();
//            System.out.println(MeterState);
//            Thread.sleep(7000);
...
//			WebDriverWaits.ClickOnWE(AddMeterIconJS);
			...
			Thread.sleep(4000);
			System.out.println("Meter register is succesfully added (before assertion)");
			// Assertion: Successfully saved meter details.
						String ActualMeterSucessMsg = WebDriverWaits.GetText(CustomerSuccessMeter);
						String ExpectedMsg = "Successfully registered meter.";
						softAssert.assertEquals(ExpectedMsg, ActualMeterSucessMsg);
						softAssert.assertAll();
						System.out.println("Successfully saved meter details.");
	...
	//		Add Meter Register			
			...
			String ActualSucessMsg2 = WebDriverWaits.GetText(CustomerSuccessMeterRegister);
			String ExpectedSucessMsg1 = "Successfully created meter register.";
			softAssert.assertEquals(ExpectedSucessMsg1, ActualSucessMsg2);
			softAssert.assertAll();
			System.out.println(ActualSucessMsg2);
		...
		//	WebDriverWaits.ClickOn(RegisterNo_DropdownOpn);
			...
			System.out.println("Successfully added initial meter reads." );
			Thread.sleep(2000);
			jse.executeScript("window.scrollTo(0, document.body.scrollHeight)");
			WebDriverWaits.ClickOn(AddMeterReads);
			Thread.sleep(1000);
			...
			WebDriverWaits.ClickOn(Save_Button);
			Thread.sleep(2000);
			System.out.println("Successfully added Actual meter reads." );
	//		jse.executeScript("window.scrollTo(0, document.body.scrollHeight)");
