...
public class Flow8_AllBillrunCycles extends Flow5_AddCustomer {
	...
	public static By Single_Rollback_Result_Close_Button =By.xpath ("//div[@class='bootstrap-dialog-footer-buttons']//button[contains(text(),'Close')]");
	public static By ViewRollbackHistory_Button =By.xpath ("//*[contains(text(),' View Rollback History')]");
	...
	public static void M_BillRunCycle() throws InterruptedException {
		...
		System.out.println(RandomCycleName1);
...
//		WebDriverWaits.WaitUntilInvisible(Spinner_Icon);
		...
		Thread.sleep(2000);
		// Because roll back is commented
		Thread.sleep(2000);
	...
	public static void Rollback_SmallBillRunWithSingleCustomer() throws InterruptedException {
		SoftAssert softAssert = new SoftAssert();
        Thread.sleep(4000);
//document.querySelector('#rollback-and-fix')
		JavascriptExecutor jser = (JavascriptExecutor) driver;
        Thread.sleep(8000);
        WebElement Rollback_Fix_Tab = (WebElement) jser.executeScript("return document.querySelector('#rollback-and-fix')");
        Thread.sleep(6000);
        Rollback_Fix_Tab.click();
//		WebDriverWaits.ClickOn(X_BillrunCycle.Rollback_and_Fix_Tab);
		WebDriverWaits.ClickOn(X_BillrunCycle.Continue_rollback_Button);
		Thread.sleep(5000);
		String ActualMsg1 = WebDriverWaits.GetText(X_BillrunCycle.RollbackCompleteSuccessMsg);
		...
		WebDriverWaits.ClickOn(X_BillrunCycle.Cancel_Button);
		Thread.sleep(2000);
		//Run bill again
		WebDriverWaits.ClickOn(Billrun.BillRun_Tab);
		jse.executeScript("window.scrollTo(0, document.body.scrollHeight)");
  ...
  //	WebDriverWaits.ClickOn(Billrun.View_Button);
        ...
        Thread.sleep(100000);
        WebDriverWaits.ClickOn(Single_Rollback_Result_Close_Button);
        Thread.sleep(3000);
...
//		Thread.sleep(2000); 
	...
	public static void SmallBillRunWithTwoCustomer() throws InterruptedException {
		...
		System.out.println(RandomCycleName2);
	...
	//	CustomerList.selectByIndex(0);
		...
		WebDriverWaits.ClickOn(CustomerListFilter);
		driver.findElement(CustomerListFilter).clear();
...
//		WebDriverWaits.WaitUntilInvisible(Spinner_Icon);
	//	WebDriverWaits.ClickOn(Billrun.View_Button);
		...
		//Search customer and re bill from customer>statement> view roll back history
...
//		Thread.sleep(2000);
//		WebDriverWaits.ClickOn(Statement_Subtab);
//		WebDriverWaits.ClickOn(ViewRollbackHistory_Button);
//		
//		
...
//		Select select2 = new Select(BillRunCycOption2);
//		Thread.sleep(2000);
//		select2.selectByVisibleText(X_BillrunCycle.RandomCycleName2);
//		//driver.findElement(By.xpath("//option[text()='" + RandomCycleName1+ "']"));
//		Thread.sleep(2000);
//		jse.executeScript("window.scrollTo(0, document.body.scrollHeight)");
//		WebDriverWaits.ClickOn(Billrun.BillRun_Button);
...
//		Thread.sleep(4000);
	...
	public static void BillRunWithLargeCycle() throws InterruptedException {
		...
		Flow6_7AddingServiceAndMeter.X_AddService.BAddservice_Meter_MeterRegister();
		Flow6_7AddingServiceAndMeter.X_AddService.AddService_Meter_MeterRegisterC();
	}
	...
	public static void LargeBillRun() throws InterruptedException {
		...
		System.out.println(RandomCycleName3);
		WebDriverWaits.ClickOn(CustomerListFilter);
		WebDriverWaits.SendKeys(CustomerListFilter, CustomerID01R);
		Thread.sleep(2000);
		WebElement CustomerListOption = WebDriverWaits.WaitUntilVisibleWE(CustomerListFilterOpn);
