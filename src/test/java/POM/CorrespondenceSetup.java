...
public class CorrespondenceSetup extends TestLogin {
    ...
    public static By correspondence = By.xpath("(//*[@class='col-lg-4 col-md-4 col-xs-4'])[36]");
    ...
    public static By backToCorrespondenceList = By.xpath("//*[@class='btn btn-success btn-next']");
    ...
    public static By deleteAttachments = By.xpath("//*[@id='importHistoryTable']/tbody/tr[2]/td[7]/a");
    ...
    public static void clickBackToCorrespondence() {
        WebDriverWaits.ClickOn(next);
