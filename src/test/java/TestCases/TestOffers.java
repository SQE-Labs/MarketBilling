...
public class TestOffers extends BaseTest {
    ...
    String RandomName1;
    String offerName = RandomStrings.RequiredCharacters(5);
    String randomOfferDisplayName = RandomStrings.RequiredCharacters(5);
    ...
    public void createOfferGroup() throws InterruptedException {
        ...
        RandomName1 = "Offer_Group_" + RandomStrings.RequiredCharacters(4);
    ...
    public void editOffer() throws InterruptedException, AWTException {
       ...
       // WebDriverWaits.validate_SuccessTXT(offerSucc_Msg,"Changes to " + offerName + " saved successfully.");
    }
}
